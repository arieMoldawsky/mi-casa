  ...
  <main class="homepage-section">
    ...
    <div class="trending-middle flex">
      <div class="trending-info-1 trending flex">
        ...
        <p>
          Personalize your search with filters—like price range or a pool—to get
      ...
      <div class="trending-info-2 trending flex">
        ...
        <p>
          Check out the photos. Then, read guest reviews from past reservations
      ...
      <div class="trending-info-3 trending flex">
        ...
        <p>
          We keep your info safe and follow global security standards to process
          your payments.
        </p>
      </div>
