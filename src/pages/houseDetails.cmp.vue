              ...
              <ul>
                <li v-for="amenity in house.amenities" :key="amenity">
                  <svg
                    ...
                    "
                  >
                    <path :d="amenityIcons[amenity]"></path>
                  </svg>
                  {{ amenity }}
                </li>
              </ul>
