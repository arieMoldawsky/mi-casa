<template>
  <main class="user-profile-section">
    <div class="user-card">
  ...
  <el-form-item>
    <el-input-number label="Price per night" v-model="house.price" @change="handleChange" :min="1" :max="10000"></el-input-number>
  </el-form-item>
  <el-form-item label="House type">
    <el-select v-model="house.type" placeholder="Please select house type">
  ...
  <el-form-item>
    <el-input-number label="House capacity" v-model="house.capacity" @change="handleChange" :min="1" :max="20"></el-input-number>
  </el-form-item>
  <el-form-item>
    <el-input-number label="Number of bedrooms" v-model="house.bedRooms" @change="handleChange" :min="1" :max="10"></el-input-number>
  </el-form-item>
  ...
  <el-form-item label="Country">
    <el-select v-model="house.location.country" placeholder="Please insert a country">
  ...
  <el-form-item label="City">
    <el-select v-model="house.location.city" placeholder="Please insert a city">
